[Discussion Post (created on 27/5/2021 at 15:20)](https://leetcode.com/problems/maximum-product-difference-between-two-pairs/discuss/1300311/Simple-O(n)-time-solution-with-explanation-and-code-in-python)  
